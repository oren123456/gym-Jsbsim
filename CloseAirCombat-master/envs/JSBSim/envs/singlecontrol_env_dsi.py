from .env_base_dsi import BaseEnv
from ..tasks.heading_task_dsi import HeadingTask
...
class SingleControlEnv(BaseEnv):
    ...
    def reset_simulators(self):
        ...
        self.log(f"reset_simulator: new heading: {init_heading}, new altitude:{init_altitude}, new velocity:{init_velocities_u}")
