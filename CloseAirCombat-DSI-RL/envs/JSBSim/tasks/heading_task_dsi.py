...
from ..core.catalogDSI_RL import Catalog as c
from ..reward_functions import AltitudeReward
from ..reward_functions.heading_reward_dsi import HeadingReward
# from  import ExtremeState, LowAltitude, Overload, Timeout, UnreachHeading
from ..termination_conditions.extreme_state_dsi import ExtremeState
from ..termination_conditions.low_altitude_dsi import LowAltitude
from ..termination_conditions.overload_dsi import Overload
from ..termination_conditions.timeout import Timeout
from ..termination_conditions.unreach_heading_dsi import UnreachHeading
...
class HeadingTask(BaseTask):
    ...
    def get_obs(self, env, agent_id):
        ...
        norm_obs[3] = obs[3] / 10000         # 3. ego_altitude   (unit: 5km)
